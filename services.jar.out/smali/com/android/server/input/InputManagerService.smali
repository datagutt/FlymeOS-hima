...
.field private static final GLOVE_EVENT_JUDGE_DISABLED:I = 0x2

.field private static final GLOVE_EVENT_JUDGE_ENABLED:I = 0x3
...
.field private final FILTER_EVENTS_PERMISSION:Ljava/lang/String;
...
.field private mIsDotViewClosed:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/input/InputManagerService;->mIsTelephonyIdle:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z

    iput-boolean v2, p0, Lcom/android/server/input/InputManagerService;->mIsScreenOn:Z
    ...
    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->FILTER_EVENTS_PERMISSION:Ljava/lang/String;
    ...
    invoke-direct {v0, v1, p0, v2}, Lcom/htc/server/gesture/GloveInputFilter;-><init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;Landroid/os/Handler;)V
...
.method static synthetic access$1200(Lcom/android/server/input/InputManagerService;)J
    .locals 2
...
.method static synthetic access$1300(JLjava/lang/String;)V
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/input/InputManagerService;)Z
    .locals 1
...
.method static synthetic access$1402(Lcom/android/server/input/InputManagerService;Z)Z
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/input/InputManagerService;)I
    .locals 1
...
.method static synthetic access$1900(Lcom/android/server/input/InputManagerService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/input/InputManagerService;->mIsScreenOn:Z

    return v0
.end method

.method static synthetic access$1902(Lcom/android/server/input/InputManagerService;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/input/InputManagerService;->mIsScreenOn:Z
...
.method static synthetic access$2000(JZ)V
    .locals 0
...
.method static synthetic access$2100(Lcom/android/server/input/InputManagerService;Z)I
    .locals 1
...
.method static synthetic access$2300(Lcom/android/server/input/InputManagerService;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/input/InputManagerService;->setGloveEventEnabledWrapper(I)V

    return-void
.end method

.method static synthetic access$2400(Lcom/android/server/input/InputManagerService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z

    return v0
.end method

.method static synthetic access$2402(Lcom/android/server/input/InputManagerService;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z

    return p1
.end method

.method static synthetic access$2500(Lcom/android/server/input/InputManagerService;[Landroid/view/InputDevice;)V
    .locals 0
...
.method static synthetic access$2600(Lcom/android/server/input/InputManagerService;II)V
    .locals 0
...
.method static synthetic access$2700(Lcom/android/server/input/InputManagerService;)V
    .locals 0
...
.method static synthetic access$2800(JLandroid/view/InputEvent;IIIIII)I
    .locals 2
...
.method private initGloveMode()V
    ...
    :goto_1
    invoke-direct {p0, v0}, Lcom/android/server/input/InputManagerService;->setGloveEventEnabledWrapper(I)V
    ...
    const-string v2, " mIsDotViewClosed:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z
    ...
    invoke-static {v2, v3, v0}, Lcom/android/server/input/InputManagerService;->nativeSetGloveInputFilterEnabled(JZ)V

    iget-wide v2, p0, Lcom/android/server/input/InputManagerService;->mPtr:J

    invoke-direct {p0, v0}, Lcom/android/server/input/InputManagerService;->getShowGloveTouchesOption(Z)I

    move-result v4

    invoke-static {v2, v3, v4}, Lcom/android/server/input/InputManagerService;->nativeSetShowGloveTouches(JI)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/input/InputManagerService;->getShowGloveTouchesOption(Z)I
    ...
    invoke-static {v2, v3, v1}, Lcom/android/server/input/InputManagerService;->nativeSetGloveInputFilterEnabled(JZ)V
...
.method private static native nativeFlushInputGloveQueue(J)V
.end method
...
.method private setGloveEventEnabledWrapper(I)V
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/input/InputManagerService;->mFakeGloveMode:Z

    if-nez v0, :cond_0

    invoke-direct {p0, p1}, Lcom/android/server/input/InputManagerService;->setGloveEventEnabled(I)V
...
.method final filterGloveInputEvent(Landroid/view/InputEvent;)I
    .locals 3
    ...
    iget-boolean v1, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/android/server/input/InputManagerService;->mIsScreenOn:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/server/input/InputManagerService;->mGloveInputFilter:Lcom/htc/server/gesture/GloveInputFilter;

    invoke-virtual {v1, p1}, Lcom/htc/server/gesture/GloveInputFilter;->onInputEvent(Landroid/view/InputEvent;)I
...
.method public flushInputGloveQueue()V
    .locals 2

    iget-wide v0, p0, Lcom/android/server/input/InputManagerService;->mPtr:J

    invoke-static {v0, v1}, Lcom/android/server/input/InputManagerService;->nativeFlushInputGloveQueue(J)V
...
.method public resetAndDropInputEvents()V
    ...
    const-string v2, "Swiping navigation bar callback happens"

    invoke-static {v0, v1, v2}, Lcom/android/server/input/InputManagerService;->nativeResetAndDropEverything(JLjava/lang/String;)V
...
.method public setFakeGloveMode(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lcom/android/server/input/InputManagerService;->mFakeGloveMode:Z
