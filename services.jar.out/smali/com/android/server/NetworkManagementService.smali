...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;-><init>(Lcom/android/server/NetworkManagementService;Lcom/android/server/NetworkManagementService$1;)V
...
.method private getPackageNamebyPID(IZ)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mActivityManager:Landroid/app/ActivityManager;
    ...
    const-string v6, "getPackageNamebyPID PackageName= "
    ...
    const-string v5, "getPackageNamebyPID fail"
...
.method private isHTCPreInstalledAPP(Ljava/lang/String;)Z
    .locals 6
    ...
    iget-boolean v0, v3, Landroid/content/pm/ApplicationInfo;->htcApp:Z
    ...
    const-string v5, "isHTCPreInstalledAPP return "
    ...
    const-string v5, "isHTCPreInstalledAPP: Can\'t get package info e="
...
.method private prepareNativeDaemon()V
    ...
    const-string v19, "/proc/net/xt_qtaguid/ctrl"
    ...
    const-string v18, "NetworkManagementService"

    const-string v19, "enabling bandwidth control"
    ...
    const-string v20, "prepareNativeDaemon netd command return. doneSignal.getCount() = "
    ...
    invoke-virtual/range {v20 .. v20}, Ljava/util/concurrent/CountDownLatch;->getCount()J
    ...
    :goto_0
    const-string v19, "net.qtaguid_enabled"
    ...
    const-string v21, " active quota rules"
    ...
    const-string v19, "problem enabling bandwidth controls"
    ...
    const-string v19, "not enabling bandwidth control"
    ...
    const-string v21, " active alert rules"
    ...
    const-string v21, " active uid rules"
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;->size()I
    ...
    const-string v21, " active uid rules by interface for firewall"
    ...
    new-instance v18, Lcom/android/server/NetworkManagementService$UidRuleArrayList;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;->iterator()Ljava/util/Iterator;
...
.method public setUidNetworkRulesByInterface(ZILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "setUidNetworkRulesByInterface: "
    ...
    invoke-direct {p0, v3, v5}, Lcom/android/server/NetworkManagementService;->getPackageNamebyPID(IZ)Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/android/server/NetworkManagementService;->isHTCPreInstalledAPP(Ljava/lang/String;)Z
    ...
    :cond_2
    :try_start_2
    iget-object v3, p0, Lcom/android/server/NetworkManagementService;->mUidRuleByInterface:Lcom/android/server/NetworkManagementService$UidRuleArrayList;

    invoke-virtual {v3, p2, p3, p4}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;->contains(ILjava/lang/String;Ljava/lang/String;)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v5, "setUidNetworkRulesByInterface: add rule which is already exist."
    ...
    const-string v8, "htcappfirewall"
    ...
    invoke-virtual {v3, p2, p3, p4}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;->add(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_5
    ...
    const-string v5, "setUidNetworkRulesByInterface: del rule which is not exist."
    ...
    invoke-virtual {v3, p2, p3, p4}, Lcom/android/server/NetworkManagementService$UidRuleArrayList;->remove(ILjava/lang/String;Ljava/lang/String;)Z
    :try_end_9
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_9 .. :try_end_9} :catch_0
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    new-instance v3, Landroid/net/wifi/WifiCustomizeReader;

    invoke-direct {v3}, Landroid/net/wifi/WifiCustomizeReader;-><init>()V
    ...
    const-string v5, "MLHD case, don\'t care channel"
    ...
    :goto_3
    iget v4, p0, Lcom/android/server/NetworkManagementService;->bandwidth:I
    ...
    :cond_5
    invoke-virtual {v3}, Landroid/net/wifi/WifiCustomizeReader;->isSupport5GHotspot()Z

    move-result v4

    if-eqz v4, :cond_c

    invoke-virtual {v3}, Landroid/net/wifi/WifiCustomizeReader;->isTMOUSSku()Z
    ...
    const-string v5, "Support5GHotspot and TMOUS sku"
    ...
    const-string v6, "band/channel 2.4G/"
    ...
    const-string v5, "Not Support5GHotspot or Not TMOUS sku"
    ...
    const-string v5, "Channel is not 2.4G, set default channel 6"
