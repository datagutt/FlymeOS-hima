...
.method static synthetic access$200(Lcom/android/server/ConnectivityService;ILjava/lang/String;)V
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    .locals 0
...
.method static synthetic access$2100(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    .locals 0
...
.method static synthetic access$2300(Lcom/android/server/ConnectivityService;)Landroid/os/INetworkManagementService;
    .locals 1
...
.method static synthetic access$500(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;ZI)V
    .locals 0
...
.method static synthetic access$5000(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Tethering;
    .locals 1
...
.method static synthetic access$5100(Lcom/android/server/ConnectivityService;)Landroid/content/ContentResolver;
    .locals 1
...
.method static synthetic access$5102(Lcom/android/server/ConnectivityService;Landroid/content/ContentResolver;)Landroid/content/ContentResolver;
    .locals 0
...
.method private checkVZWPermission(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 9
    ...
    const-string v4, "checkVZWPermission packageName = "
    ...
    const-string v3, "checkVZWPermission CONTENT_URI = "
    ...
    const-string v3, "checkVZWPermission result = "
...
.method private handleAsyncChannelDisconnected(Landroid/os/Message;)V
    ...
    const-string v20, " got DISCONNECTED, was satisfying "
    ...
    iget-boolean v0, v13, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z
    ...
    invoke-interface/range {v19 .. v20}, Landroid/os/INetworkManagementService;->removeNetwork(I)V
    ...
    invoke-direct {v0, v13}, Lcom/android/server/ConnectivityService;->isDefaultNetwork(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    const-string v20, "enable_cmcc_userdecided_wifi_mobile_handoff"

    const/16 v21, 0x1

    invoke-static/range {v19 .. v21}, Landroid/provider/HtcISettingsSystem$Agent;->getBoolean(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z
    ...
    const-string v20, "handleAsyncChannelDisconnected userEnableNotify="
    ...
    const-string v20, ", isWiFiDefaultNetwork="
    ...
    invoke-virtual/range {v19 .. v22}, Landroid/net/NetworkInfo;->setDetailedState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v13}, Lcom/android/server/ConnectivityService;->updateClat(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget v0, v15, Landroid/net/NetworkRequest;->requestId:I
    ...
    const-string v20, "Checking for replacement network to handle request "
    ...
    invoke-direct {v0, v15, v1, v2}, Lcom/android/server/ConnectivityService;->sendUpdatedScoreToFactories(Landroid/net/NetworkRequest;IZ)V
    ...
    iget-object v0, v15, Landroid/net/NetworkRequest;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual/range {v19 .. v20}, Landroid/net/NetworkCapabilities;->satisfiedByNetworkCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    const-string v20, "Exception removing network: "
    ...
    const-string v20, "Exception to get setting, e="
    ...
    const-string v20, " found replacement in "
    ...
    invoke-direct {v0, v13}, Lcom/android/server/ConnectivityService;->removeDataActivityTracking(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {v0, v13}, Lcom/android/server/ConnectivityService;->notifyLockdownVpn(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->remove(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private handleReleaseNetworkRequest(Landroid/net/NetworkRequest;I)V
    ...
    invoke-virtual {v7, v8}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    const-string v8, "no live requests for legacyType"
...
.method private isSignaturePermitted(I)Z
    ...
    const-string v1, "isSignaturePermitted checkVZWPermission"
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->getPackageNamebyPID(IZ)Ljava/lang/String;

    move-result-object v1

    const-string v2, "VZW800APN"

    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->checkVZWPermission(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private notifyUserSelection()V
    ...
    iput-boolean v8, p0, Lcom/android/server/ConnectivityService;->mIsNotifying:Z
    ...
    const-string v9, "notifyUserSelection: defaultNai = "
    ...
    :goto_1
    invoke-direct {p0, v9, v7, v8}, Lcom/android/server/ConnectivityService;->sendUpdatedScoreToFactories(Landroid/net/NetworkRequest;IZ)V
    ...
    const-string v9, "notifyUserSelection: existing = "
    ...
    invoke-virtual {v7, v9}, Landroid/net/NetworkCapabilities;->satisfiedByNetworkCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    const-string v9, "notifyUserSelection, found replacement in "
    ...
    iget-object v7, v5, Lcom/android/server/connectivity/NetworkAgentInfo;->networkLingered:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v5, v8}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
...
.method private rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    const-string v23, "rematchNetworkAndRequests: uncreated network being rematched."
    ...
    const-string v23, " anymore. Remove request."
    ...
    invoke-interface/range {v22 .. v22}, Landroid/os/INetworkManagementService;->clearDefaultNetId()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v23, "Exception clear default network :"
    ...
    new-instance v22, Landroid/net/IpPrefix;
    ...
    invoke-static/range {v23 .. v23}, Ljava/net/InetAddress;->getByName(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-direct/range {v22 .. v24}, Landroid/net/IpPrefix;-><init>(Ljava/net/InetAddress;I)V
    ...
    const-string v23, "setMultiCastFilterRule error message: "
