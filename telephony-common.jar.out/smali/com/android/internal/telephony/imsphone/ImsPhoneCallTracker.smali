...
.field private static final EXTRAS_HANDOVER_INFORMATION:Ljava/lang/String; = "handoverInfo"

.field private static final EXTRA_TYPE_LTE_TO_IWLAN_HO_FAIL:I = 0x1
...
.field private mEPDGChanged:Z

.field private mEPDGFailCount:I
...
.method constructor <init>(Lcom/android/internal/telephony/imsphone/ImsPhone;)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mSyncState:Ljava/lang/Object;
    ...
    .line 256
    iput-boolean v3, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGChanged:Z

    .line 257
    iput v3, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGFailCount:I
...
.method static synthetic access$1600(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    .param p1, "x1"    # Lcom/android/ims/ImsCall;
    .param p2, "x2"    # Lcom/android/internal/telephony/Call$State;
    ...
    .prologue
    .line 95
    invoke-direct/range {p0 .. p5}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->processCallStateChange(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZZ)Z
...
.method static synthetic access$1802(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;Z)Z
    ...
    .prologue
    .line 95
    iput-boolean p1, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGChanged:Z

    return p1
.end method

.method static synthetic access$1900(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;

    .prologue
    .line 95
    iget v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGFailCount:I

    return v0
.end method

.method static synthetic access$1902(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 95
    iput p1, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGFailCount:I

    return p1
.end method

.method static synthetic access$1908(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    ...
    iput v1, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGFailCount:I
...
.method static synthetic access$2000(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
...
.method private processCallStateChange(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->processCallStateChange(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZZ)Z

    .line 1131
    return-void
.end method

.method private processCallStateChange(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZZ)Z
    .locals 10
    .param p1, "imsCall"    # Lcom/android/ims/ImsCall;
    .param p2, "state"    # Lcom/android/internal/telephony/Call$State;
    .param p3, "cause"    # I
    .param p4, "ignoreState"    # Z
    .param p5, "updateCallstate"    # Z
    ...
    const-string v9, "processCallStateChange state="
    ...
    const-string v9, " updateCallstate="
    ...
    .line 1157
    invoke-virtual {v3, p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->update(Lcom/android/ims/ImsCall;)Z
    ...
    .line 1174
    .local v0, "assignEPDGIcon":Z
    iget-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mConnections:Ljava/util/ArrayList;
    ...
    .line 1175
    .local v5, "imsConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    invoke-virtual {v1}, Lcom/android/ims/ImsCall;->showEPDGIcon()Z
    ...
    .line 1178
    const-string v8, "assign EPDG icon for each call"
    ...
    .end local v5    # "imsConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_4
    if-ne v0, v7, :cond_9
    ...
    .line 1186
    .restart local v5    # "imsConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    invoke-virtual {v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getImsCall()Lcom/android/ims/ImsCall;

    move-result-object v1

    .line 1188
    .restart local v1    # "call":Lcom/android/ims/ImsCall;
    if-eqz v1, :cond_5

    .line 1189
    invoke-virtual {v1, v7}, Lcom/android/ims/ImsCall;->setEPDGIcon(Z)V

    goto :goto_2

    .line 1160
    .end local v0    # "assignEPDGIcon":Z
    .end local v1    # "call":Lcom/android/ims/ImsCall;
    .end local v4    # "i$":Ljava/util/Iterator;
    .end local v5    # "imsConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_6
    invoke-virtual {v3, p1, p2}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->update(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;)Z
    ...
    .line 1163
    invoke-virtual {v3, p3}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(I)Z
    ...
    invoke-virtual {v8, v3}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->detach(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    ...
    .line 1196
    .restart local v0    # "assignEPDGIcon":Z
    .restart local v4    # "i$":Ljava/util/Iterator;
    :cond_9
    if-nez v2, :cond_a

    iget-boolean v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGChanged:Z

    if-eqz v8, :cond_0

    .line 1197
    :cond_a
    iput-boolean v6, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGChanged:Z
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mHandoverCall:Lcom/android/internal/telephony/imsphone/ImsPhoneCall;
...
.method private transferHandoverConnections(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    iput-object v3, v0, Lcom/android/internal/telephony/Connection;->mPreHandoverState:Lcom/android/internal/telephony/Call$State;
    ...
    const-string v4, "Connection state before handover is "
    ...
    iput-object v4, v3, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->mConnections:Ljava/util/ArrayList;
    ...
    .line 1916
    invoke-virtual {p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->isMultiparty()Z
    ...
    .line 1927
    :cond_3
    const-string v3, "conference call but mConnections is null"
    ...
    invoke-virtual {v3}, Lcom/android/ims/ImsCall;->close()V
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->changeParent(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    const-string v4, "Call is alive and state is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p1, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->mState:Lcom/android/internal/telephony/Call$State;
    ...
    iput-object v4, v3, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->mState:Lcom/android/internal/telephony/Call$State;

    .line 1949
    :cond_7
    invoke-virtual {p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->clearState()V
...
.method private updatePhoneState()V
    ...
    .line 810
    :cond_4
    iput-boolean v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGChanged:Z

    .line 811
    iput v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mEPDGFailCount:I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(Z)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->showRemoteTtyMsg(I)V
...
.method hangup(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(Z)Z
...
.method hangup(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    ...
    .prologue
    .line 944
    const-string v5, "hangup connection"
    ...
    const-string v7, "does not belong to ImsPhoneCallTracker "
    ...
    .line 953
    .local v2, "call":Lcom/android/internal/telephony/imsphone/ImsPhoneCall;
    if-eqz v2, :cond_3

    invoke-virtual {v2}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->isMultiparty()Z
    ...
    .line 956
    .local v1, "addressArray":[Ljava/lang/String;
    ...
    .end local v1    # "addressArray":[Ljava/lang/String;
    const/4 v5, 0x0

    aput-object v0, v1, v5

    .line 960
    .restart local v1    # "addressArray":[Ljava/lang/String;
    :cond_1
    if-eqz v4, :cond_2
    ...
    const-string v6, "hangup address: "
    ...
    .line 963
    invoke-virtual {v4, v1}, Lcom/android/ims/ImsCall;->removeParticipants([Ljava/lang/String;)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .restart local v1    # "addressArray":[Ljava/lang/String;
    .restart local v4    # "imsCall":Lcom/android/ims/ImsCall;
    :catch_0
    move-exception v3
...
.method notifySrvccState(Lcom/android/internal/telephony/Call$SrvccState;)V
    ...
    const-string v3, "notifySrvccState state="
    ...
    .line 1960
    iget-object v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mSrvccState:Lcom/android/internal/telephony/Call$SrvccState;
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->transferHandoverConnections(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    const-string v3, "notifySrvccState handover connections size: "
