...
.method private encode16bitEms(Lcom/android/internal/telephony/cdma/sms/UserData;[B)V
    ...
    invoke-static {p2, v8, v5, v7, v6}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    invoke-static {v0, v8, v5, v6, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private encode7bitEms(Lcom/android/internal/telephony/cdma/sms/UserData;[BZ)V
    ...
    invoke-static {p2, v5, v3, v6, v4}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private encodeBitStream([BIII)I
    ...
    .param p2, "startBitIndex"    # I
    .param p3, "lengthOfBits"    # I
    .param p4, "fillinValue"    # I
...
.method private encodeTeleserviceParamUserDataEx([B)[B
    ...
    invoke-static {v5, v6, v3, v2, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private encodeTimeRelative(Lcom/android/internal/telephony/cdma/CdmaSmsIdValue$RelativeTime;I)B
    .locals 5
    .param p1, "typeOfTime"    # Lcom/android/internal/telephony/cdma/CdmaSmsIdValue$RelativeTime;
    .param p2, "fixedMinutes"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private encodeTransportParamAddress(Z[B)[B
    ...
    invoke-static {v13, v14, v7, v15, v0}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private encodeTransportParamBearerData([B)[B
    ...
    .line 1059
    .end local p1    # "prefixData":[B
    :goto_0
    return-object p1

    .line 1052
    .restart local p1    # "prefixData":[B
    :cond_0
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CdmaSmsEncoder;->TransportParam_bearerData:[B
...
.method public fillinTeleserviceParamCallBack(Lcom/android/internal/telephony/cdma/CdmaSmsIdValue$AddrNumberType;B[B)V
    .locals 3
    .param p1, "addrType"    # Lcom/android/internal/telephony/cdma/CdmaSmsIdValue$AddrNumberType;
    .param p2, "addrPlan"    # B
    .param p3, "addrString"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public fillinTeleserviceParamReplyOption(ZZZZ)V
    .locals 3
    .param p1, "manualAckRequest"    # Z
    .param p2, "deliveryAckRequest"    # Z
    .param p3, "readAckRequest"    # Z
    .param p4, "deliveryReportRequest"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public fillinTeleserviceParamUserData(BS[B[B)V
    .locals 2
    .param p1, "userDataEncoding"    # B
    .param p2, "extendedInfo"    # S
    .param p3, "userDataHeader"    # [B
    .param p4, "userData"    # [B
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public fillinTeleserviceParamUserData(B[BLjava/lang/String;)V
    .locals 2
    .param p1, "userDataEncoding"    # B
    .param p2, "userDataHeader"    # [B
    .param p3, "payloadStr"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public fillinTransportParamCauseCodes(BBB)V
    .locals 3
    .param p1, "replySeqNumber"    # B
    .param p2, "errorClass"    # B
    .param p3, "errorDetail"    # B
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
