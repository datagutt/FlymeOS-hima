...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v2, v3, p0}, Lcom/android/internal/telephony/ProxyController;->unregisterForAllDataDisconnected(JLandroid/os/Handler;)V
...
.method protected pollStateDone()V
    ...
    const-string v9, "pollStateDone: lte 1 ss=["
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;
    ...
    .line 298
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mSS:Landroid/telephony/ServiceState;
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;
    ...
    .line 505
    .local v3, "hasDeregistered":Z
    :goto_1
    invoke-super {p0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->pollStateDone()V
    ...
    .line 508
    .local v0, "arrayCi":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/telephony/CellInfo;>;"
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfo:Landroid/telephony/CellInfo;
    ...
    .line 511
    .local v2, "cil":Landroid/telephony/CellInfoLte;
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mNewCellIdentityLte:Landroid/telephony/CellIdentityLte;

    iget-object v10, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLasteCellIdentityLte:Landroid/telephony/CellIdentityLte;

    invoke-virtual {v8, v10}, Landroid/telephony/CellIdentityLte;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLasteCellIdentityLte:Landroid/telephony/CellIdentityLte;

    .line 518
    invoke-virtual {v2, v5}, Landroid/telephony/CellInfoLte;->setRegistered(Z)V

    .line 519
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLasteCellIdentityLte:Landroid/telephony/CellIdentityLte;

    invoke-virtual {v2, v8}, Landroid/telephony/CellInfoLte;->setCellIdentity(Landroid/telephony/CellIdentityLte;)V
    ...
    const-string v10, " mCellInfo="

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v10, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfo:Landroid/telephony/CellInfo;
    ...
    .line 526
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfo:Landroid/telephony/CellInfo;
    ...
    :cond_1
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mPhoneBase:Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v8, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyCellInfo(Ljava/util/List;)V
    ...
    .line 298
    .end local v0    # "arrayCi":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/telephony/CellInfo;>;"
    .end local v1    # "cidChanged":Z
    .end local v2    # "cil":Landroid/telephony/CellInfoLte;
    .end local v3    # "hasDeregistered":Z
    ...
    .line 511
    .restart local v0    # "arrayCi":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/telephony/CellInfo;>;"
    .restart local v2    # "cil":Landroid/telephony/CellInfoLte;
    .restart local v3    # "hasDeregistered":Z
    :cond_4
    const/4 v1, 0x0
