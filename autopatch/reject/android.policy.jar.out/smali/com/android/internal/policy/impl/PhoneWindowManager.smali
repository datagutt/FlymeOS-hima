...
>>>>>>> BOSP #Conflict 0
        ...
        Lcom/android/internal/policy/impl/PhoneWindowManager$KillToast;,
        Lcom/android/internal/policy/impl/PhoneWindowManager$GlobalActionReceiver;,
        Lcom/android/internal/policy/impl/PhoneWindowManager$VolumeLongPressRunnable;,
...
.field mVolumeKeyPressedEvent:Landroid/view/KeyEvent;

.field private mVolumeLongKey:I

.field mVolumeLongKeyWakeLock:Landroid/os/PowerManager$WakeLock;

.field private final mVolumeLongPressRunnable:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/internal/policy/impl/PhoneWindowManager$VolumeLongPressRunnable;

    invoke-direct {v0, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$VolumeLongPressRunnable;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
...
.method static synthetic access$1200(Lcom/android/internal/policy/impl/PhoneWindowManager;)Lcom/android/internal/policy/impl/BarController;
    .locals 1
...
.method private cancelPendingVolumeLongPress()V
    .locals 2

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongKey:I
...
.method private interceptVolumeLongPress(IJ)V
    .locals 6

    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getSysMediaTweak()I
    ...
    iput p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongKey:I
...
.method private launchBackKeyLongPressAction()V
    ...
    invoke-virtual {v15}, Landroid/view/ViewConfiguration;->getDeviceGlobalActionKeyTimeout()J
...
.method private sendDozePulse()V
    .locals 4
...
.method private sendMediaKey(I)V
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p0, p1, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendEvent(III)V
    ...
    const-string v2, "Inject event failed, could not send media key"
...
.method private sendVolumeKeyEventInner(Landroid/view/KeyEvent;Z)V
    .locals 3
    ...
    iput-object p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeKeyPressedEvent:Landroid/view/KeyEvent;

    goto :goto_0

    :cond_0
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongPressed:Z
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeKeyPressedEvent:Landroid/view/KeyEvent;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/media/session/MediaSessionLegacyHelper;->sendVolumeKeyEvent(Landroid/view/KeyEvent;Z)V

    :cond_2
    :goto_0
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongPressed:Z
...
<<<<<<< VENDOR #Conflict 2
    if-eqz p1, :cond_8
======= #@.method private updateSystemBarsLw@
...
<<<<<<< VENDOR #Conflict 5
    move-object v0, p0
======= #@.method public addStartingWindow@
    :try_start_1
...
======= #@.method public beginPostLayoutPolicyLw@
    #iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHideLockScreen:Z
>>>>>>> BOSP #Conflict 9
...
<<<<<<< VENDOR #Conflict 10
======= #@.method public canBeForceHidden@
    .prologue
...
<<<<<<< VENDOR #Conflict 11
======= #@.method public checkShowToOwnerOnly@
    .prologue
...
.method public getSysBackKeyTweak()Z
    ...
    const-string v2, "tweaks_backkey_kill"
...
.method public getSysMediaTweak()I
    .locals 4
    ...
    const-string v2, "tweaks_volkey_media"
...
<<<<<<< VENDOR #Conflict 12
======= #@.method public hideBootMessages@
    .prologue
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    const-string v5, "PhoneWindowManager.mVolumeLongKeyWakeLock"

    invoke-virtual {v2, v3, v5}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongKeyWakeLock:Landroid/os/PowerManager$WakeLock;
...
<<<<<<< VENDOR #Conflict 13
    ...
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->initGlobalActionReceiver()V
...
>>>>>>> BOSP #Conflict 14
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBackKeyLongPressed:Z
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBackKeyLongPressed:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/os/PowerManager;->isActualScreenOn()Z
    ...
    const-string v25, "ActualScreenOn="
    ...
    :goto_6
    sget-boolean v23, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_HTC:Z
    ...
    const-string v25, "interceptKeyTq key="
    ...
    new-instance v24, Lcom/android/internal/policy/impl/PhoneWindowManager$PassKey;
    ...
    invoke-virtual/range {v23 .. v25}, Landroid/os/PowerManager;->wakeUpFromPowerKey(J)V
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->isShowingAndNotOccluded()Z
    ...
    const-string v23, "InputDispatcher"

    const-string v24, "interceptQueue mShowingShutdownAnim=true, do not wake up device "
    ...
    const-string v25, "<POWER DOWN> Device wake up by isWakeKey = "
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptVolumeLongPress(IJ)V
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/policy/impl/PhoneWindowManager$RingingSilentFlag;->setFlag()V
    ...
    const-string v25, "Click VOLUME key to silence mode, keyCode="
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->cancelPendingVolumeLongPress()V
    ...
    sget-boolean v23, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEnable2KeyHWResetDevice:Z
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z
    ...
    const-string v24, "removeCallbacks for HW reset notification UI 2KeyHWResetHint"
    ...
    const-string v24, "removeCallbacks for HW reset notification UI 2KeyHWResetIndicator"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendVolumeKeyEventInner(Landroid/view/KeyEvent;Z)V
    ...
    const-string v24, "<VOLUME>just pass it to the session service."
    ...
    const-string v24, "<VOLUME>send it to the session manager to figure out."
    ...
    const-string v24, "POWER+HOME to screenshot"
    ...
    const-string v23, "com.htc.intent.action.WRITE_TRACEPOINT"
    ...
    const-string v24, "com.htc.intent.action.WRITE_TRACEPOINT has been broadcasted."
    ...
    const-string v24, "remove PASS_TO_USER flag after screenshot"
    ...
    invoke-virtual {v0, v12, v1, v2, v3}, Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;->onPowerKeyDown(ZJZ)Z
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/policy/impl/PhoneWindowManager$RingingSilentFlag;->getFlag()Z
    ...
    const-string v24, "<POWER DOWN>Click POWER key to end call"
    ...
    const-string v25, "needHandleDotviewLongPressPowerkey=Ture dotview="
    ...
    const-string v24, "<POWER DOWN>Click POWER key to silence mode"
    ...
    const-string v24, "removeCallbacks for HW reset notification UI"
...
>>>>>>> BOSP #Conflict 18
    ...
    const-string v24, "Suppressed redundant power key press while already in the process of turning the screen on."
...
>>>>>>> BOSP #Conflict 20
    ...
    const-string v23, "com.htc.cover.closed"
...
>>>>>>> BOSP #Conflict 21
    ...
    const-string v25, "BroadCast cover changed intent (north, state) = ("
    ...
    const-string v24, "Camera key has been blocked because Setup Wizard (OOBE) has not completed."
    ...
    invoke-interface/range {v23 .. v23}, Landroid/app/IActivityManager;->isInLockTaskMode()Z
    ...
    const-string v24, "POWER+BACK to stopLockTaskMode"
    ...
    const-string v24, "remove PASS_TO_USER flag after stopLockTaskMode"
    ...
    const-string v24, "Unable to reach activity manager"
...
<<<<<<< VENDOR #Conflict 24
======= #@.method public prepareAddWindowLw@
    .prologue
...
.method public showGlobalActionsAdv()V
    .locals 1

    const/4 v0, 0x1

    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashlightMode:I
...
.method public volumeLongPressAction()V
    .locals 4

    const/16 v1, 0x19

    iget v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongKey:I
    ...
    :sswitch_0
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendDozePulse()V
    ...
    :goto_2
    invoke-direct {p0, v0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendMediaKey(I)V
...
<<<<<<< VENDOR #Conflict 27
======= #@.method public windowTypeToLayerLw@
    .prologue
