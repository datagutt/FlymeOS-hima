...
.field private static final LAYER_CACHE_DEFAULT:I = 0x1000000

.field private static final LAYER_CACHE_FHD:I = 0x3000000

.field private static final LAYER_CACHE_FHD_2G:I = 0x1800000
...
.field private static final MEM_BOUND_2G:J = 0x80000000L
...
.field private static final TEXTURE_CACHE_DEFAULT:I = 0x1800000

.field private static final TEXTURE_CACHE_FHD:I = 0x4800000

.field private static final TEXTURE_CACHE_FHD_2G:I = 0x2400000

.field private static final TEXTURE_CACHE_FLUSH_RATE:F = 0.6f
...
.method private enableHardwareAcceleration(Landroid/view/WindowManager$LayoutParams;)V
    ...
    iput-boolean v8, v9, Landroid/view/View$AttachInfo;->mHardwareAccelerated:Z

    iget-object v9, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    iput-boolean v8, v9, Landroid/view/View$AttachInfo;->mHardwareAccelerationRequested:Z

    sget-boolean v9, Landroid/view/ViewRootImpl;->DEBUG_HTC:Z
    ...
    iget v9, p1, Landroid/view/WindowManager$LayoutParams;->privateFlags:I
    ...
    :cond_5
    sget-boolean v9, Landroid/view/HardwareRenderer;->sRendererDisabled:Z
    ...
    invoke-virtual {v9}, Landroid/view/HardwareRenderer;->destroy()V

    :cond_7
    iget v9, p1, Landroid/view/WindowManager$LayoutParams;->format:I
    ...
    invoke-static {v9, v6}, Landroid/view/HardwareRenderer;->create(Landroid/content/Context;Z)Landroid/view/HardwareRenderer;

    move-result-object v9

    iput-object v9, v8, Landroid/view/View$AttachInfo;->mHardwareRenderer:Landroid/view/HardwareRenderer;
    ...
    invoke-virtual {v8, v9}, Landroid/view/HardwareRenderer;->setName(Ljava/lang/String;)V

    iget-object v8, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    iget-object v9, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    iput-boolean v7, v9, Landroid/view/View$AttachInfo;->mHardwareAccelerationRequested:Z
    ...
    iget-boolean v7, v7, Landroid/content/pm/ApplicationInfo;->htcApp:Z
    ...
    const-string v8, "Non-HTC App: Enlarge cache config for FHD, <= 2G RAM"
    ...
    invoke-static {v7, v8, v12}, Landroid/view/HardwareRenderer;->setHWUICacheConfig(IIF)V
    ...
    const-string v8, "Non-HTC App: Enlarge cache config for FHD, > 2G RAM and QuadHD"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_c
    const/high16 v7, 0x4800000
...
>>>>>>> BOSP #Conflict 0
    ...
    :try_start_1
    const-string v4, "FindExtension"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "FindExtension: before mHardwareRenderer.initialize, mSurface.isValid() = "
