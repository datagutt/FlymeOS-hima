...
.method private static isABTFeatureSupported()Z
    .locals 7
    ...
    const-string v4, "support_abt_feature"
...
.method private startOtherServices()V
    ...
    new-instance v4, Landroid/net/wifi/WifiCustomizeReader;

    invoke-direct {v4}, Landroid/net/wifi/WifiCustomizeReader;-><init>()V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/SystemServer;->mWifiCustomizeReader:Landroid/net/wifi/WifiCustomizeReader;
    ...
    .catch Ljava/lang/RuntimeException; {:try_start_3 .. :try_end_3} :catch_46
    ...
    new-instance v66, Lcom/android/server/HtcHardwareService;

    move-object/from16 v0, v66

    invoke-direct {v0, v3}, Lcom/android/server/HtcHardwareService;-><init>(Landroid/content/Context;)V
    :try_end_5
    .catch Ljava/lang/RuntimeException; {:try_start_5 .. :try_end_5} :catch_47
    ...
    new-instance v52, Lcom/android/server/ConsumerIrService;
    ...
    new-instance v36, Lcom/android/server/HtcActiveEngineManager;
    ...
    invoke-static {v4, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b
    .catch Ljava/lang/Throwable; {:try_start_b .. :try_end_b} :catch_44
    ...
    invoke-static {v4, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_f
    .catch Ljava/lang/Throwable; {:try_start_f .. :try_end_f} :catch_43
    ...
    :goto_12
    invoke-static {}, Lcom/android/server/SystemServer;->getWlanSolution()I
    ...
    const-string v5, "Regulatory Observer"

    invoke-static {v4, v5}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v95, Lcom/android/server/RegulatoryObserver;

    move-object/from16 v0, v95

    invoke-direct {v0, v3}, Lcom/android/server/RegulatoryObserver;-><init>(Landroid/content/Context;)V
    :try_end_20
    ...
    :try_start_27
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/content/ContentService;->systemReady()V
    :try_end_27
    ...
    :cond_11
    :goto_1c
    invoke-static {}, Lcom/android/server/SystemServer;->isABTFeatureSupported()Z
    ...
    const-string v5, "Absolute Persistence Service"

    invoke-static {v4, v5}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v4, "ABTPersistenceService"

    new-instance v5, Lcom/absolute/android/persistservice/ABTPersistenceService;

    invoke-direct {v5, v3}, Lcom/absolute/android/persistservice/ABTPersistenceService;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v4, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_3a
    .catch Ljava/lang/Throwable; {:try_start_3a .. :try_end_3a} :catch_35
    ...
    :try_start_46
    const-string v32, "com.htc.htclogservice"
    ...
    const-string v8, "com.htc.htclogservice"

    invoke-virtual {v4, v5, v8}, Lcom/android/server/pm/PackageManagerService;->checkPermission(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v4, "com.htc.htclogservice"

    const-string v5, "com.htc.htclogservice.HtcLogStarterService"
    ...
    new-instance v45, Lcom/android/server/BluetoothManagerService;
    ...
    const-string v4, "starting RegulatoryObserver"
    ...
    const-string v5, "Failure starting Absolute Persistence Service"
    ...
    const-string v5, "Skip HtcLogService"
    ...
    const-string v4, "Failed to init HtcLogService"
