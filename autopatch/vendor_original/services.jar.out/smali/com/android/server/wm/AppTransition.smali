...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZZZLcom/android/server/wm/AppTransition$HtcStartRecentAppTransition;)Landroid/view/animation/Animation;
    .locals 18
    ...
    sget-boolean v6, Lcom/android/server/wm/AppTransition;->DEBUG_APP_TRANSITIONS:Z
    ...
    :cond_3
    const-string v6, "AppTransition"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "applyAnimation voice: anim="
    ...
    invoke-virtual/range {p12 .. p12}, Lcom/android/server/wm/AppTransition$HtcStartRecentAppTransition;->isHack()Z
    ...
    sget-boolean v6, Lcom/android/server/wm/WindowManagerService;->sIsLowEndGfx:Z
    ...
    invoke-virtual {v15, v6}, Landroid/view/animation/Animation;->setFillEnabled(Z)V

    const/4 v6, 0x1

    invoke-virtual {v15, v6}, Landroid/view/animation/Animation;->setFillBefore(Z)V

    const/4 v6, 0x1

    invoke-virtual {v15, v6}, Landroid/view/animation/Animation;->setFillAfter(Z)V

    sget-boolean v6, Lcom/android/server/wm/WindowManagerService;->DEBUG_HTC:Z

    if-eqz v6, :cond_a

    const-string v6, "AppTransition"

    const-string v7, "Overwrite next app transition"
    ...
    const-string v8, "applyAnimation: anim="
    ...
    iget-boolean v6, v0, Lcom/android/server/wm/AppTransition;->mNextAppTransitionScaleUp:Z
