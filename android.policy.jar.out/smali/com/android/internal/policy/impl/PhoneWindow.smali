...
.field private static final HTC_COMMON_CONTROL_RES_PACKAGE:Ljava/lang/String; = "com.htc"
...
.method private getAlternativeColor(II)I
    .locals 5
...
.method private getCCCatogory(I)I
    .locals 6
...
.method private getColorFromRes(Ljava/lang/String;)I
    .locals 6
...
.method private getNavBarColorMod(I)I
    ...
    iget v5, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mStatusBarColor:I
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/policy/impl/PhoneWindow;->isHTCItem(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/policy/impl/PhoneWindow;->getColorFromRes(Ljava/lang/String;)I

    move-result v2

    if-eqz v2, :cond_0

    invoke-direct {p0, v2}, Lcom/android/internal/policy/impl/PhoneWindow;->getCCCatogory(I)I

    move-result v3

    invoke-direct {p0, v2, v3}, Lcom/android/internal/policy/impl/PhoneWindow;->getAlternativeColor(II)I
...
.method private getNavBarTweak()Z
    ...
    const-string v2, "tweaks_navbar_color"
