...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$10200(Landroid/media/AudioService;)I
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$10202(Landroid/media/AudioService;I)I
    ...
    invoke-static {v3, v0, v1, v2}, Landroid/media/AudioService;->access$10300(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    :cond_19
    const-string v3, "com.htc.intent.action.EFFECT_ICON_NOTIFICATION"
    ...
    const-string v5, "Receive Effect NOTIFICATION from Native AudioTrack!!! notificationOn="
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$8900(Landroid/media/AudioService;)Landroid/media/htcsoundfx/HtcEffectManagerInterface;
    ...
    invoke-interface/range {v3 .. v9}, Landroid/media/htcsoundfx/HtcEffectManagerInterface;->sendMsg(IIIILjava/lang/Object;I)V
    ...
    check-cast v44, Lcom/htc/service/WirelessDisplayManager;

    invoke-virtual/range {v44 .. v44}, Lcom/htc/service/WirelessDisplayManager;->getMirrorDisplayStatus()Z
    ...
    invoke-interface {v3, v4, v0}, Landroid/media/htcsoundfx/HtcEffectManagerInterface;->onEventChanged(IZ)V
    ...
    check-cast v42, Landroid/hardware/display/WifiDisplayStatus;
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/hardware/display/WifiDisplayStatus;->getActiveDisplayState()I
    ...
    invoke-interface {v3, v4, v5}, Landroid/media/htcsoundfx/HtcEffectManagerInterface;->onEventChanged(IZ)V
    ...
    :cond_26
    const-string v3, "com.htc.intent.action.SURROUNDSOUND_SETTINGS"
    ...
    const-string v5, "intent ACTION_SURROUNDSOUND_SETTINGS, KEY_EFFECT_ENABLE="
    ...
    invoke-interface {v3, v4, v0}, Landroid/media/htcsoundfx/HtcEffectManagerInterface;->setSystemProperty(II)V

    goto/16 :goto_1

    :cond_27
    const-string v3, "com.htc.intent.action.ALL_PLAY_LPCM"
    ...
    const-string v5, "intent ACTION_ALLPLAY_STATUS, KEY_ALLPLAY_STATUS="
