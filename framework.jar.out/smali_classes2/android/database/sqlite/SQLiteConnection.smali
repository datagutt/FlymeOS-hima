...
.field private static final sEnableServo:Z
...
.method static constructor <clinit>()V
    ...
    const-class v3, Landroid/database/sqlite/SQLiteConnection;
    ...
    :goto_0
    sput-boolean v3, Landroid/database/sqlite/SQLiteConnection;->$assertionsDisabled:Z

    new-array v3, v5, [Ljava/lang/String;

    sput-object v3, Landroid/database/sqlite/SQLiteConnection;->EMPTY_STRING_ARRAY:[Ljava/lang/String;

    new-array v3, v5, [B

    sput-object v3, Landroid/database/sqlite/SQLiteConnection;->EMPTY_BYTE_ARRAY:[B
    ...
    sput-object v3, Landroid/database/sqlite/SQLiteConnection;->TRIM_SQL_PATTERN:Ljava/util/regex/Pattern;
    ...
    const-string v4, "Servo is enabled."

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    sput-boolean v2, Landroid/database/sqlite/SQLiteConnection;->sEnableServo:Z
    ...
    sput-object v3, Landroid/database/sqlite/SQLiteConnection;->records:Ljava/util/HashMap;

    sput-object v6, Landroid/database/sqlite/SQLiteConnection;->mSearchableDB:Ljava/util/Properties;

    const/16 v3, 0xb

    sput v3, Landroid/database/sqlite/SQLiteConnection;->mThreshold:I

    sput-object v6, Landroid/database/sqlite/SQLiteConnection;->package_name:Ljava/lang/String;

    sput-object v6, Landroid/database/sqlite/SQLiteConnection;->receiver:Ljava/lang/String;
...
.method private static final ensureReceiverInited()V
    .locals 11

    sget-object v9, Landroid/database/sqlite/SQLiteConnection;->mSearchableDB:Ljava/util/Properties;
    ...
    const-string v9, "/system/etc/searchabledb.conf"
    ...
    sput-object v9, Landroid/database/sqlite/SQLiteConnection;->package_name:Ljava/lang/String;
    ...
    sput-object v9, Landroid/database/sqlite/SQLiteConnection;->receiver:Ljava/lang/String;
    ...
    sput v9, Landroid/database/sqlite/SQLiteConnection;->mThreshold:I
    :try_end_2
    ...
    sget-object v10, Landroid/database/sqlite/SQLiteConnection;->package_name:Ljava/lang/String;

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v10, "/files/searchabledb.conf"
    ...
    invoke-virtual {v9, v7}, Ljava/util/Properties;->putAll(Ljava/util/Map;)V
    :try_end_4
    ...
    :goto_3
    :try_start_7
    const-string v9, "SQLiteConnection"

    const-string v10, "Cannot read configuration file for seachable databases."
